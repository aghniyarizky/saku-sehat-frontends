...
//             if (!response.ok) {
//                 console.error("ISI ERROR TAMBAH PENGELUARAN DARI SERVER:", teksResponse);
//                 try {
...
export default function Pengeluaran({ onSuccess }: PengeluaranProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        /*
        // DINOAKTIFKAN SEMENTARA UNTUK DEMO (TANPA INTEGRASI BE)
        try {
        ...
        */
        ...
        // Simulasi respons berhasil (Offline / Standalone Mode)
        setTimeout(() => {
            setSuccess(true);
            setCatatanTransaksi("");
            setSelectedCategory("");
