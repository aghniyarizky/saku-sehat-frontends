  ...
  return (
    <div className="w-full min-h-screen flex bg-[#101828]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-linear-to-br from-[#0c1320] via-[#101828] to-[#0a2e2a] items-center justify-center px-14">
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#2EC4B6]/20 rounded-full blur-3xl" />
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#2EC4B6]/10 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-10">
            Gratis untuk mahasiswa. Daftar sekarang dan mulai catat setiap
            pemasukan & pengeluaranmu dalam hitungan menit.
          </p>

          <div className="space-y-4">
            {[
              { icon: "bolt", text: "Pendaftaran cepat, tanpa ribet" },
              { icon: "school", text: "Dirancang khusus untuk mahasiswa" },
              { icon: "verified_user", text: "Privasi & datamu terlindungi" },
            ].map((item) => (
