          ...
          <div className="p-4">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold tracking-wider text-white">Email</label>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold tracking-wider text-white">Nama Lengkap</label>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-400 backdrop-blur-md focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent transition-all">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold tracking-wider text-white">Username</label>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-400 backdrop-blur-md focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent transition-all">
                  <span className="material-icons text-gray-300 text-sm select-none"> person </span>
                  <input 
                    type="text" 
              ...
              <button 
                type="submit" 
                disabled={loading} 
                className="w-full py-2.5 mt-4 bg-[#2EC4B6] hover:bg-[#23a89b] text-[#101828] font-bold rounded-full shadow-lg shadow-blue-950/50 transition-all active:scale-[0.98] cursor-pointer disabled:bg-gray-600"
              >
